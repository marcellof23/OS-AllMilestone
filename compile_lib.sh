...
ld86 -o ./bin/ln -d ./output/ln.o ./output/lib_asm.o ./output/shellStringUtil.o ./output/shellFolderIO.o ./output/fileIO.o ./output/math.o
...
ld86 -o ./bin/tictactoe -d ./output/tictactoe.o ./output/lib_asm.o ./output/stringutil.o ./output/math.o ./output/fileIO.o ./output/shellFolderIO.o